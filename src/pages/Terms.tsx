      ...
      <div className="container max-w-4xl space-y-8">
        ...
        <div className="prose prose-sm dark:prose-invert max-w-none space-y-6 text-muted-foreground">
          ...
          <section className="space-y-3">
            ...
            <p>Star9 Freelancer Ltd provides an online learning platform (Star9 Academy), a job and study abroad board (Star9 Global), community features, and related freelancer support services.</p>
          </section>
