...
BEGIN
  ...
  IF ref_code IS NOT NULL AND ref_code != '' THEN
    ...
    IF parent_id IS NOT NULL THEN
      ...
      VALUES (new.id, new.raw_user_meta_data->>'full_name', new.email, user_role, new.referral_code, parent_id);
  ...
  VALUES (new.id, new.raw_user_meta_data->>'full_name', new.email, user_role, new.referral_code);
